...
/**La classe StockInfo permet l'affichage du menu sur linterface du robot
 * l'attribut campOpp indique le camp adverse soit le camp ou doit etre depose le palet
 * l'attribut campDep indique le camp de depart
 */
